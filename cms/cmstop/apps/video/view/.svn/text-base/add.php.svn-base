...
<table border="0" width="70%" >
  <tr>
    <td><input type="text" name="video" id="video" value="<?=$video?>" size="60" style="margin-right:30px;"/></td>
  </tr>
  <tr>
  <td>
  <table><tr>
  ...
  <?php endif; ?>
	...
	<tr id="ptline" style="display:none">
	   <th>时长：</th><td>  <input type="text" name="playtime" id="playtime" value="<?=$playtime?>" size="10"/>分钟</td>
	</tr>
    <tr>
		<th></th>
		<td>
