...
<div class="tag_1 mar_l_8">
	<ul class="tag_list">
		<li><a href="javascript:tableApp.load('type=count');" class="s_3" id="most">举报最多</a></li>
		<li><a href="javascript:tableApp.load('type=time');" id="new">最新举报</a></li>
	</ul>
</div>
...
var tableApp = new ct.table('#content', {
	...
	baseUrl  : '?app=<?=$app?>&controller=<?=$controller?>&action=report_page&disabled=<?=$disabled?>'
});
