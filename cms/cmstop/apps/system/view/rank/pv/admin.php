...
<div class="tag_1">
   <div id="add_data">
	...
	<ul class="tag_list" style="margin-left:160px">
	    <li><a href="?app=system&controller=rank_pv&action=index">全站排行</a></li>
...
var tableApp = new ct.table('#item_list', {
    ...
    baseUrl  : '?app=system&controller=rank_pv&action=page'
});
...
$("#admin_tree span").click(function(){
	...
	tableApp.load('userid='+this.id+'&created_min='+$('#created_min').val()+'&created_max='+$('#created_max').val());
