...
<div class="tag_1">
   <div id="add_data">
	...
	<ul class="tag_list" style="margin-left:160px">
	    ...
	    <li><a href="?app=system&controller=rank_pv&action=category" class="s_3">按栏目排行</a></li>
...
$('#category').tree({
	url:"?app=system&controller=rank_pv&action=cate&catid=%s",
	paramId : 'catid',
	...
	prepared:function(){
		var t = this;
		$.getJSON('?app=system&controller=rank_pv&action=category_path&catid='+current_catid, function(path){
			t.open(path);
		});
	}
});
