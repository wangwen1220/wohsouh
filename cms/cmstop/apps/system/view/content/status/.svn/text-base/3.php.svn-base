...
<?php if ($_roleid < 3) {?>
      ...
      <input type="button" name="pass" onclick="content.pass();" value="通过" class="button_style_1"/>
      ...
      <input type="button" name="reject" onclick="content.reject();" value="退稿" class="button_style_1"/>
