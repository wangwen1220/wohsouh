  ...
  <div class="table_foot">
    ...
    <p class="f_l">
      <input type="button" name="restore" onclick="content.restore();" value="还原" class="button_style_1"/>
      ...
      <input type="button" name="delete" onclick="content.del();" value="彻底删除" class="button_style_1"/>
      <input type="button" name="delete" onclick="content.clear(<?=$catid?>,'<?=$name?>');" value="清空回收站" class="button_style_1"/>
