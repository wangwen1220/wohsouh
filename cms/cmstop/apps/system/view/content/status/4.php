  ...
  <div id="unpublishedby_x" class="th_pop" style="display:none;width:150px">
     <input type="text" id="unpublishedbyname" size="12" /> <input type="button" value="查询" onclick="tableApp.load('unpublishedbyname='+$('#unpublishedbyname').val());"/>
     <ul>
...
<?php if ($_roleid < 3) {?>
      ...
      <input type="button" name="publish" onclick="content.publish();" value="发布" class="button_style_1"/>
