...
<div class="tag_1">
	<ul class="tag_list">
		<li class="s_3"><a href="?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=action">操作权限</a></li>
		<li><a href="?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=category">栏目权限</a></li>
		<li><a href="?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=section">区块权限</a></li>
	</ul>
    <p class="f_r mar_r_8">
