...
if(!submitcheck('searchsubmit', 1)) {
	...
	dheader("location: http://www.huoshow.com/app/?srchtype=title&srhfid=0&srchtxt=".$_G['gp_srchtxt']."&searchsubmit=true&mod=portal&app=search&controller=index&type=all&wd=".$_G['gp_srchtxt']."&action=search");
