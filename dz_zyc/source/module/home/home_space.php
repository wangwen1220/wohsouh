...
$dos = array('index', 'doing', 'blog', 'album', 'friend', 'wall',
	...
	'thread', 'trade', 'poll', 'activity', 'debate', 'reward', 'profile','video','audio', 'myshow', 'pay','gifts','withdraw','live','mystical','giftcoupons','acceptgift','sendgift','index_weibo');
...
if(empty($space)) {
	if(in_array($do, array('doing', 'blog', 'album', 'share', 'home', 'thread', 'trade', 'poll', 'activity', 'debate', 'reward', 'group', 'myshow', 'pay'))) {
		$_GET['view'] = 'all';
		$space['uid'] = 0;
	} else {
