...
.selectdiv{float:left;width:850px;margin-top:4px !important;margin-top:5px;}
...
.sts_check{border:0;background:#fff;}
...
<?php } ?>
	...
	&nbsp;&nbsp;
	<input class="btn" type="button" name="sel_refresh" id="sel_refresh" value="刷 新" onclick="javascript:subsel();"/>
</div>
</form>
</td></tr>
</table>
...
<td width="70" align="left">
	<input type="submit" name="handin" id="handin" value="提交" class="btn" />
</td>
<td align="right" class="pagebar">
<?php echo $pager?>
</td>
</tr>
</table>
