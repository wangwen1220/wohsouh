...
$idtypes = array('thread'=>'tid', 'forum'=>'fid', 'blog'=>'blogid', 'group'=>'gid', 'album'=>'albumid', 'space'=>'uid', 'article'=>'aid', 'myshow'=>'myshowid');
...
function makeurl($id, $idtype, $spaceuid=0) {
	...
	switch($idtype) {
		case 'tid':
			...
			break;
		case 'myshowid':
			$url = 'home.php?mod=space&do=myshow&view=me&id='.$id;
			break;
		case 'fid':
