...
EOT;
		...
		//+
		$search_audio = array(
				$setting['search']['audio']['status'] ? '<input type="checkbox" class="checkbox" name="settingnew[search][audio][status]" value="1" checked="checked" />' : '<input type="checkbox" class="checkbox" name="settingnew[search][audio][status]" value="1" />',
				cplang('setting_search_status_audio'),
				'<input type="text" class="txt" name="settingnew[search][audio][searchctrl]" value="'.$setting['search']['audio']['searchctrl'].'" />',
				'<input type="text" class="txt" name="settingnew[search][audio][maxspm]" value="'.$setting['search']['audio']['maxspm'].'" />',
				'<input type="text" class="txt" name="settingnew[search][audio][maxsearchresults]" value="'.$setting['search']['audio']['maxsearchresults'].'" />',
			);
		$search_video = array(
				$setting['search']['video']['status'] ? '<input type="checkbox" class="checkbox" name="settingnew[search][video][status]" value="1" checked="checked" />' : '<input type="checkbox" class="checkbox" name="settingnew[search][video][status]" value="1" />',
				cplang('setting_search_status_video'),
				'<input type="text" class="txt" name="settingnew[search][video][searchctrl]" value="'.$setting['search']['video']['searchctrl'].'" />',
				'<input type="text" class="txt" name="settingnew[search][video][maxspm]" value="'.$setting['search']['video']['maxspm'].'" />',
				'<input type="text" class="txt" name="settingnew[search][video][maxsearchresults]" value="'.$setting['search']['video']['maxsearchresults'].'" />',
			);
		//end
		...
		//+
		showtablerow('', '', $search_audio);
		showtablerow('', '', $search_video);
		//end
		showtablefooter();
