...
$menu['topic'] = array(
	...
	//+
	array('menu_maint_myshow', 'myshow_verification'),
	//end
);
...
$menu['extended'] = array(
	...
	array('menu_problem', 'problem'),
	//+ 
	array('menu_huoshowcoin', 'huoshowcoin_search'),
	//end
	...
	array('menu_liveplayer', 'liveplayer'),
	array('menu_live', 'live'),
	array('memu_jilu', 'jilu'),	
	array('memu_order', 'order'),
	array('menu_duixian', 'duixian'),
	array('menu_bank','bank'),
	array('memu_showcoin', 'showcoin'),
	array('memu_coinstat', 'coinstat'),
	array('memu_giftwatch', 'giftwatch'),
	array('memu_gift', 'gift'),
	array('memu_activity', 'activity'),
	array('menu_keyword','keyword'),
	array('menu_huoshowno','huoshowno'),
	array('menu_pk','pk'),
	array('menu_film','film'),
	array('menu_charm','charm'),
	array('menu_sendstar','sendstar'),
	array('menu_financial','financial'),
	//end
);
