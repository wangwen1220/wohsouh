...
$admincp_actions_normal = array('huoshow','index', 'setting', 'members', 'profilefields', 'admingroup', 'usergroups',
	'forums', 'threadtypes', 'threads', 'moderate', 'attach', 'smilies', 'recyclebin', 'prune',
	'styles', 'addons', 'plugins', 'tasks', 'magics', 'medals', 'google', 'announce', 'faq', 'ec','problem',
	...
	'district', 'diytemplate', 'verify', 'nav', 'domain', 'myshow', 'huoshowcoin', 'liveplayer','jilu','order','duixian',
	'bank','showcoin', 'live','keyword','activity','gift','huoshowno','pk','film','charm','sendstar','coinstat',"giftwatch","financial");
