...
$html.='<span style="float:left;">欢迎你：'.$res['username'].'
		&nbsp;&nbsp;</span><span style="float:right;"><a class="panel_center_quit" href="'.WWW_HOST.'member.php?mod=logging&action=logout&formhash='.FORMHASH.'">退出</a></span></div>
