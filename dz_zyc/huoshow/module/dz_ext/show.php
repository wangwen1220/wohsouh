...
if(!in_array($mod, array('index','my','somebody','fans','gift','receviegift','addfans','addnote','voterank','getnote','campaign1','kge','showmyshow','test','watch','create','player','player_swf','rank','frank','vrank','zrank','yrank','personalinfo','live','live_1'))) 
{
	$mod = 'index';
	$_GET['do'] = 'show';
