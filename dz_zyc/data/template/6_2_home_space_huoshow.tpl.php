<? if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_huoshow');
0
|| checktplrefresh('./template/huoshow/home/space_huoshow.htm', './template/huoshow/common/userabout.htm', 1357269420, '2', './data/template/6_2_home_space_huoshow.tpl.php', './template/huoshow', 'home/space_huoshow')
...
<? if($do=='weibo' or $do=='weibo_user_fans' or $do == 'weibo_userfollow' or $do == 'weibo_followgroupmsg') { ?>
<a href="home.php?mod=huoshow&amp;do=weibo">微博管理</a> <em>&rsaquo;</em>
<? } else { ?>
<a href="home.php?mod=huoshow&amp;do=live">直播间管理</a> <em>&rsaquo;</em>
<? } ?> 	
</div>
</div>
...
<link rel="stylesheet" type="text/css" href="/static2/gifts.css" />

<div id="ct" class="ct2_a wp cl">
<div class="mn"><?php require_once(DISCUZ_ROOT."huoshow/module/home/home_".$do.".php"); ?></div>
