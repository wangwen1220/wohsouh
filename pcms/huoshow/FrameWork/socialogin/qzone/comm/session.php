...
{
    //mysql的主机地址
    const db_host = GLOBAL_MYSQL_IP; //需要第三方指定ip地址 

    //数据库用户名
    const db_user = GLOBAL_MYSQL_USER;   //需要第三方指定自己的用户名

    //数据库密码
    const db_pwd = GLOBAL_MYSQL_PWD; //需要第三方指定自己的库据库密码

    //数据库
    const db_name = GLOBAL_MYSQLBASE;      //需要第三方指定数据库
 ...
 */
define("MAIN_DOMAIN", ".huoshow.com");   //设置主域名
