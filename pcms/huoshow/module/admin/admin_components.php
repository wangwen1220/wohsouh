...
$page_record = 10;
$count = $dblink->getRow("SELECT count(*) as count FROM pre_match_plugin order by id");
$components_count = $count[0]["count"];
$components_arr = $dblink->getRow("SELECT * FROM pre_match_plugin order by id limit ".($page-1)*$page_record.",$page_record");
//关闭数据库链接
$dblink->dbclose();
//获得分页字符串
...
$smarty1->assign("components_arr",$components_arr);
$smarty1->display("admin/admin_components.html");
?>