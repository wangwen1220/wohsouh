<?php /* Smarty version 2.6.26, created on 2012-03-27 10:07:52
         compiled from home/home_weibo_user_recommend.html */ ?>
<div class="wbfans">
             <h3 class="font14">可能感兴趣的人</h3>
            	 <ul class="clFrame">
				 		<?php unset($this->_sections['bo']);
$this->_sections['bo']['name'] = 'bo';
$this->_sections['bo']['loop'] = is_array($_loop=$this->_tpl_vars['user_recommend']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
<?php echo $this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['uid']; ?>
" title=""><img src="<?php echo $this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['head_img_url']; ?>
"></a>
							<p><a href="<?php echo $this->_tpl_vars['space_url']; ?>
<?php echo $this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['uid']; ?>
" title=""  class="uname"><?php echo $this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['name']; ?>
</a></p>
							<?php if ($this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['is_att'] == 0 && $this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['uid'] != $this->_tpl_vars['uid']): ?>
							<p><a class="jsadd" href="/huoshow/module/weibo/ajax/weibo_user_dynamic_ajax.php?tab=ajax_user_follow&dst_uid=<?php echo $this->_tpl_vars['user_recommend'][$this->_sections['bo']['index']]['uid']; ?>
"
