...
function change_images(uploadid,returnid){
	...
	$.each( contents, function(i, n) {
		...
		str += "<li id='image"+ids+"' class='fn_img_item' data-id='"+i+"' order='"+i+"'><input type='text' name='"+returnid+"_url[]' value='"+n+"' style='width:310px;' ondblclick='image_priview(this.value);' class='input-text'> <input type='text' name='"+returnid+"_alt[]' value='"+filename+"' style='width:160px;' class='input-text' onfocus=\"if(this.value == this.defaultValue) this.value = ''\" onblur=\"if(this.value.replace(' ','') == '') this.value = this.defaultValue;\"> <a href=\"javascript:remove_div('image"+ids+"')\">移除</a><span  class='fn_up' ><img src='/statics/images/up.gif' width='16' height='16' /></span><span  class='fn_down' ><img src='/statics/images/down.gif' width='16' height='16' /></span><img class='img' style='display:block; margin-top:4px' src='"+n+"' width='120' height='120' /> </li>";
		});
