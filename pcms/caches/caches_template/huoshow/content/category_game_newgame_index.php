	...
	<div id='content'>
		...
		<div id='main'>
			<div id='myfocus-hs-pithy' class='ui-myfocus'>
				...
				<div class="pic">
					<ul>
					<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=3a2c946528a165fb049f5d2ea8c00c07&action=position&posid=486&order=listorder+DESC&num=3\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'486','order'=>'listorder DESC','limit'=>'3',));}?>
						<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
						    <li><a href="<?php echo url_change($r[url]);?>" target='_blank'><img src='<?php echo thumb($r[thumb],542,220);?>' alt='<?php echo $r['title'];?>' width='542' height='220' /></a></li>
					    <?php $n++;}unset($n); ?>
			...
			<div class='ui-content-box'>
				...
				<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=5a27cd581fab065a6fa2c4937224cab6&action=position&posid=571&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'571','order'=>'listorder DESC','limit'=>'12',));}?>
		        <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
					<div class='ui-content-item'>
						...
						<p class='cnt'><?php echo str_cut($r['description'],180,'');?><a class='detail' href="<?php echo url_change($r[url]);?>" target='_blank'>[详细]</a></p>
					</div>
				<?php $n++;}unset($n); ?>
				<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
				</div>
