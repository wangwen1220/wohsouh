...
<head>
	...
	<!-- <link href='<?php echo JS_PATH;?>mygallery/skin/classic.css' rel='stylesheet' /> -->
	<!-- <script src='<?php echo JS_PATH;?>jquery-1.7.2.min.js'></script> -->
	<!-- <script src='<?php echo JS_PATH;?>mygallery/jquery-mygallery.js'></script> -->
	<!-- <script src='<?php echo JS_PATH;?>cssrefresh.js'></script> -->
	<link href='/favicon.ico' rel='icon' />
</head>

<body class='game-wp game-wp-show'>
	...
	<div id='content'>
		...
		<div id='main' class='article-box'>
			...
			<div class='content'>
				<?php include template('content', 'hs_mygallery_dev'); ?>
				...
				<p>而正值热恋中的何洁和赫子铭也用实际行动对这一传闻予以回击。22日感恩节晚，何洁和男友赫子铭在微博中晒出两人贴面搭肩的亲密合影，并肉麻互说爱你，赫子铭更称遇见何洁是自己最大的幸福，甜蜜之情溢于言表。而正值热恋中的何洁和赫子铭也用实际行动对这一传闻予以回击。22日感恩节晚，何洁和男友赫子铭在微博中晒出两人贴面搭肩的亲密合影，并肉麻互说爱你，赫子铭更称遇见何洁是自己最大的幸福，甜蜜之情溢于言表。而正值热恋中的何洁和赫子铭也用实际行动对这一传闻予以回击。22日感恩节晚，何洁和男友赫子铭在微博中晒出两人贴面搭肩的亲密合影，并肉麻互说爱你，赫子铭更称遇见何洁是自己最大的幸福，甜蜜之情溢于言表。而正值热恋中的何洁和赫子铭也用实际行动对这一传闻予以回击。22日感恩节晚，何洁和男友赫子铭在微博中晒出两人贴面搭肩的亲密合影，并肉麻互说爱你，赫子铭更称遇见何洁是自己最大的幸福，甜蜜之情溢于言表。</p>
				<p><a href='#'><img src='http://www.huoshow.com/upload/2011/1021/thumb_hs_0_600_1319186459276.jpg' alt='' width='' height='' /></a><a href='#'><img src='http://www.huoshow.com/upload/2011/1014/1318578004594.jpg' alt='' width='' height='' /></a>更传男出方另有意中人。有媒体认为，赫子铭向何洁示爱事发突然，两人从相识到示爱全程未走漏半点风声。与二人的无头爱情相比，赫子铭与刘思言这对荧屏情侣似乎更得观众认可。甚至有何洁粉丝在赫子铭微博留言，希望他别当下一个释小龙。</p>
			...
			<form id='comment' class='article-related article-comment' method='post' action=''>
				<div class='header-news'>
		...
		<div id='side'>
			...
			<div class='ui-box-side ui-box-side-top'>
				<h2 class='ui-box-side-title'>装机必备 <span class='link'><a class='more' href='#'>更多&gt;&gt;</a></span></h2>
				<ul class='ui-list fn-clear'>
					<li class='ui-list-item'><a href='#'>赫子铭与刘思言这对荧屏情侣似乎更得观众认可。甚至有何洁粉丝在赫子铭微博留言，希望他别当下一个释小龙</a></li>
					<li class='ui-list-item'><a href='#'>赫子铭与刘思言这对荧屏情侣似乎更得观众认可。甚至有何洁粉丝在赫子铭微博留言，希望他别当下一个释小龙</a></li>
					<li class='ui-list-item'><a href='#'>赫子铭与刘思言这对荧屏情侣似乎更得观众认可。甚至有何洁粉丝在赫子铭微博留言，希望他别当下一个释小龙</a></li>
			...
			<div class='ui-box-side ui-box-side-gallery'>
				...
				<ul class='ui-img-list ui-img-list-plus'>
					<li class='ui-img-list-item'>
						<a class='img' href='#'><img src='http://img14.meitudata.com/5060600dc41128585.jpg!thumb235' width='122' height='92' /></a>
			...
			<div class='ui-box-side ui-box-side-gallery'>
				...
				<ul class='ui-img-list ui-img-list-plus'>
					<li class='ui-img-list-item'>
						<a class='img img-mgame img-mgame-50' href='#'><img src='http://img14.meitudata.com/5060600dc41128585.jpg!thumb235' width='50' height='50' /><span class='mark-img'></span></a>
						<a class='title' href='#'>大话西战歌</a>
					</li>
					<li class='ui-img-list-item'>
						<a class='img img-mgame img-mgame-50' href='#'><img src='http://img14.meitudata.com/5060600dc41128585.jpg!thumb235' width='50' height='50' /><span class='mark-img'></span></a>
