...
<head>
	...
	<link href='<?php echo CSS_PATH;?>hs-index.css?v=20130223' rel='stylesheet' />
...
<body>
	...
	<div id='header' class='fn-clear'>
		<a class='logo' href='http://www.huoshow.com/' title='火秀网'></a>
	...
	<div class='ui-content ui-content-sub fn-clear'>
		<div class="ui-content-item-side">
			...
			<div id='js-box-lite' class="ui-box-lite">
				...
				<ul class='ui-arts'>
					<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
					<li class='ui-art'>
						<a class='ui-art-img' href='http://myshow.huoshow.com/show-<?php echo $r['id'];?>.html' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo $r['small'];?>' alt='' width='58' height='58' /></a>
					...
					<div class="ui-tab-cnt-item">
						...
						<ul class="ui-rank">
							...
							<li class='<?php if($n==1 || $n==2 || $n==3 || $n==6 || $n==9) { ?>ui-rank-item ui-rank-item-up<?php } elseif ($n==4 || $n==7 || $n==8) { ?>ui-rank-item ui-rank-item-down<?php } else { ?>ui-rank-item<?php } ?> <?php if($n==1) { ?>ui-rank-item-cur<?php } ?>'>
								<a target="_blank" class='ui-rank-item-img' href='<?php echo url_change($r[url]);?>'><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],90,62);?>' alt='' width='90' height='62' /></a>
		...
		<div class='ad'><a href='http://myshow.huoshow.com' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/index_middle_anner.jpg' width='752' height='100' /></a></div>
			...
			<div class="ui-content-item-left ui-tab">
				...
				<div class="ui-tab-cnt">
					<div class="ui-tab-cnt-item">
						...
						<?php if($n==1) { ?>
							<div class='ui-art-album'>
								<a target="_blank" href="<?php echo url_change($r[url]);?>"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],120,90);?>' alt='<?php echo $r['title'];?>' width='120' height='90' /></a>
					...
					<div class="ui-tab-cnt-item">
						...
						<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-ilist-item">
								<a class='ui-ilist-item-img' href='<?php echo url_change($r[url]);?>'><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],104,72);?>' alt='' width='104' height='72' /></a>
			...
			<div class="ui-content-item-center ui-tab">
				...
				<div class="ui-tab-cnt">
					<div class="ui-tab-cnt-item">
						...
						<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-ilist-item">
								<a target="_blank" class='ui-ilist-item-img' href='<?php echo url_change($r[url]);?>'><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],104,72);?>' alt='' width='104' height='72' /></a>
	...
	<div class='ui-content ui-content-thr fn-clear'>
		<div class="ui-content-item-side">
			...
			<div class="ui-tab-side ui-tab">
				<ul class="ui-tab-nav fn-cf">
					<li class="ui-tab-nav-item ui-tab-nav-item-cur">论坛</li>
					<li class='ui-tab-nav-item'>晒图</li>
				</ul>
				<div class="ui-tab-cnt">
					<div class="ui-tab-cnt-item">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=0ef92040271055148cd6fb993c57ebe5&action=get_click_high&img=1&order=LIMIT+1&cache=60\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$tag_cache_name = md5(implode('&',array('img'=>'1','order'=>'LIMIT 1',)).'0ef92040271055148cd6fb993c57ebe5');if(!$data = tpl_cache($tag_cache_name,60)){$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'get_click_high')) {$data = $content_tag->get_click_high(array('img'=>'1','order'=>'LIMIT 1','limit'=>'20',));}if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data');}}?>
						<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
						<div class='ui-art fn-clear'>
							<a target="_blank" class='ui-art-img' href='<?php echo $r['url'];?>'><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[img],85,60);?>' alt='' width='85' height='60' /></a>
							<h2 class='ui-art-title'><?php echo str_cut($r['subject'],10,'');?></h2>
							<p class="ui-art-cnt"><?php echo str_cut($r['subject'],100,'');?><a target="_blank" class='detail' href='<?php echo $r['url'];?>'>[详细]</a></p>
						</div>
						<?php $n++;}unset($n); ?>
						<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=ac8b2fcf44c18fe1e5db519023160c3b&action=get_click_high&order=LIMIT+9&cache=60\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$tag_cache_name = md5(implode('&',array('order'=>'LIMIT 9',)).'ac8b2fcf44c18fe1e5db519023160c3b');if(!$data = tpl_cache($tag_cache_name,60)){$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'get_click_high')) {$data = $content_tag->get_click_high(array('order'=>'LIMIT 9','limit'=>'20',));}if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data');}}?>
						<ul class="ui-list">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<?php if($n!=1) { ?>
							<li class="ui-list-item"><a target="_blank" href='<?php echo $r['url'];?>'><?php echo str_cut($r['subject'],40,'');?></a></li>
							<?php } ?>
							<?php $n++;}unset($n); ?>
						</ul>
						<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=d450617f7a2fb84e11ce2f80bd1fd267&action=get_click_pic_high&img=1&order=LIMIT+1&id=66&cache=60\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$tag_cache_name = md5(implode('&',array('img'=>'1','order'=>'LIMIT 1','id'=>'66',)).'d450617f7a2fb84e11ce2f80bd1fd267');if(!$data = tpl_cache($tag_cache_name,60)){$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'get_click_pic_high')) {$data = $content_tag->get_click_pic_high(array('img'=>'1','order'=>'LIMIT 1','id'=>'66','limit'=>'20',));}if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data');}}?>
						<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
						<div class='ui-art fn-clear'>
							<a target="_blank" class='ui-art-img' href='<?php echo $r['url'];?>'><img src='/statics/images/common/transparent.gif' data-src='<?php echo thumb($r[img],85,60);?>' alt='' width='85' height='60' /></a>
							<h2 class='ui-art-title'><?php echo str_cut($r['subject'],10,'');?></h2>
							<p class="ui-art-cnt"><?php echo str_cut($r['subject'],100,'');?><a target="_blank" class='detail' href='<?php echo $r['url'];?>'>[详细]</a></p>
						</div>
						<?php $n++;}unset($n); ?>
						<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=5aaa9176a9e21c30f8d103e66fffcef8&action=get_click_pic_high&order=LIMIT+9&id=66&cache=60\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$tag_cache_name = md5(implode('&',array('order'=>'LIMIT 9','id'=>'66',)).'5aaa9176a9e21c30f8d103e66fffcef8');if(!$data = tpl_cache($tag_cache_name,60)){$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'get_click_pic_high')) {$data = $content_tag->get_click_pic_high(array('order'=>'LIMIT 9','id'=>'66','limit'=>'20',));}if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data');}}?>
						<ul class="ui-list">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<?php if($n!=1) { ?>
							<li class="ui-list-item"><a target="_blank" href='<?php echo $r['url'];?>'><?php echo str_cut($r['subject'],40,'');?></a></li>
		...
		<div class='ad ad-left'><a href='http://game.huoshow.com/' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/index_ad2.jpg' width='392' height='100' /></a></div>
		<div class='ad ad-center'><a href='http://www.huoshow.com/movie/' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/index_ad3.jpg' width='352' height='100' /></a></div>
			...
			<div class="ui-content-item-center ui-tab">
				...
				<div class="ui-tab-cnt">
					<div class="ui-tab-cnt-item">
						...
						<?php if($n==1) { ?>
							<div class='ui-art-album'>
								<a target="_blank" href="<?php echo url_change($r[url]);?>"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],120,90);?>' alt='<?php echo url_change($r[url]);?>' width='120' height='90' /></a>
								<h3><a href="<?php echo url_change($r[url]);?>"> <?php echo str_cut($r['title'],28,'');?></a></h3>
							</div>
							<?php } else { ?>
							<?php if($n==2) { ?><ul class="ui-list"><?php } ?>
					...
					<div class="ui-tab-cnt-item">
						...
						<ul class="ui-ilist ui-ilist-plus fn-clear">
							...
							<li class="ui-ilist-item">
								...
								<img src='/statics/images/common/transparent.gif' lazy-src='<?php echo $r['img']['0'];?>' alt='' width='104' height='88' /></a>
		...
		<div class='ad ad-bottom'>
			<a class='ad ad-left' href='http://myshow.huoshow.com/zj-1846.html' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/index_ad4.jpg' width='392' height='100' /></a>
			<a class='ad ad-right' href='http://myshow.huoshow.com/fl-5.html' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/index_ad5.jpg' width='352' height='100' /></a>
		</div>
	</div>
	<!-- ui-content thr end -->
	...
	<div class='ui-content ui-content-footer fn-clear'>
		<div class="ui-content-item-side">
			<div class='ad-side'><a href='<?php echo $CATEGORYS['9']['url'];?>' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/index_ad6.png' width='200' height='80' /></a></div>
			<div class='ad-side ad-side-footer'><a href='http://www.xtep.com/index.html' target="_blank"><img src='/statics/images/common/transparent.gif' lazy-src='<?php echo IMG_PATH;?>common/bottom_ad7_banner.png' width='200' height='210' /></a></div>
		</div>

		<div id='js-tab-gallery' class='ui-tab-gallery ui-tab'>
			<ul class="ui-tab-nav fn-clear">
					<li class="ui-tab-nav-item ui-tab-nav-item-cur">美图</li>
					<li class='ui-tab-nav-item'>明星写真</li>
					<li class='ui-tab-nav-item'>电影剧照</li>
					<li class='ui-tab-nav-item'>电视剧照</li>
					<li class='ui-tab-nav-item'>音乐美图</li>
					<li class='ui-tab-nav-item'>超模写真</li>
					<li class='ui-tab-nav-item'>赛事图集</li>
					<li class='ui-tab-nav-item'>游戏图集</li>
				</ul>
				<div class="ui-tab-cnt">
					<div class="ui-tab-cnt-item">
						...
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
								...
								<li class="ui-img-list-item">
									<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
										<img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],181,240);?>' alt='' width='181' height='240' />
							...
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
								<?php if($n==2 || $n==3) { ?>
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
									<img src='/statics/images/common/transparent.gif' lazy-src='<?php echo thumb($r[thumb],181,119);?>' alt='' width='181' height='119' />
									<span class='title'><?php echo str_cut($r['title'],40,'');?></span>
								</a>
								<?php } ?>
							<?php $n++;}unset($n); ?>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=40e3cd09956d09e2d05a97e76cf63162&action=position&posid=385&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'385','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
									<img src='/statics/images/common/transparent.gif' data-src='<?php echo thumb($r[thumb],120,119);?>' alt='' width='120' height='119' />
									<span class='title'><?php echo str_cut($r['title'],40,'');?></span>
								</a>
							</li>
							<?php $n++;}unset($n); ?>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=80b703dec98f0a86a70cac6287b578b1&action=position&posid=396&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'396','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=47e0eb637829f9f4c4945faa24314a8f&action=position&posid=386&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'386','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=dbdfc959117cd4f3a9bc9a0d31e94345&action=position&posid=387&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'387','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=a0cd18408e6c1768d46f577e25fb578f&action=position&posid=388&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'388','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=c2a4e9dcacad4288f4cdd31c88de4195&action=position&posid=389&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'389','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
					...
					<div class="ui-tab-cnt-item fn-hide">
						<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=f39f347ddf6614aa50f4df3997e432bc&action=position&posid=390&order=listorder+DESC&num=12\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'390','order'=>'listorder DESC','limit'=>'12',));}?>
						<ul class="ui-img-list fn-clear">
							<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
							<li class="ui-img-list-item">
								<a target="_blank" class='wrapper' href='<?php echo url_change($r[url]);?>'>
	...
	<script src='<?php echo JS_PATH;?>hs-index.js?v=20130223'></script>
