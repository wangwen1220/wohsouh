...
cmsAD_9.ADContent = "{'Images':[{'imgADLinkUrl':'http%3A%2F%2Fwww.phpcms.cn','imgADAlt':'','ImgPath':'http://pnews.ck.huoshow.com/uploadfile/poster/4.gif'}],'imgADLinkTarget':'New','Count':'1','showAlt':'Y'}"; 
cmsAD_9.URL = "http://pnews.ck.huoshow.com/index.php?m=poster&c=index"; 
cmsAD_9.SiteID = 1; 
cmsAD_9.Width = 330; 
cmsAD_9.Height = 50; 
