...
cmsAD_6.ADContent = "{'Images':[{'imgADLinkUrl':'http%3A%2F%2Fwww.phpcms.cn','imgADAlt':'官方','ImgPath':'http://pnews.ck.huoshow.com/uploadfile/poster/5.gif'}],'imgADLinkTarget':'New','Count':'1','showAlt':'Y'}"; 
cmsAD_6.URL = "http://pnews.ck.huoshow.com/index.php?m=poster&c=index"; 
cmsAD_6.SiteID = 1; 
cmsAD_6.Width = 248; 
cmsAD_6.Height = 162; 
