...
<!--
	$(function(){
		...
		$("#name").formValidator({onshow:"请输入属性分类",onfocus:"请输入属性分类",oncorrect:"<?php echo L('input_right');?>"}).inputValidator({min:1,onerror:"请输入属性分类"});
	})
//-->
</script>
<form action="?m=special&c=special&a=special_edit_class" method="post" id="myform">
<table class="table_form" width="100%" cellspacing="0">
<tbody>
	<tr>
		<th width="100"><strong>属性分类名称：</strong></th>
