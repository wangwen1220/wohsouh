...
<tr>
<td><?php echo '接受推荐专题'?></td> 
<td>
<label></label><input type="radio" name="info[is_zhuanti]" value="0" <?php if($is_zhuanti==0) echo "checked=checked" ?>  />否</label>
<label></label><input type="radio" name="info[is_zhuanti]" value="1" <?php if($is_zhuanti==1) echo "checked=checked" ?> />是</label>
</td>
</tr> 
