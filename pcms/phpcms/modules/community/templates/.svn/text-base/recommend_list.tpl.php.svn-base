...
<input type="hidden" value="recommend_list" name="a">
	...
	<div class="table-list">
	    <table id='js-table' width="100%" cellspacing="0" >
		    ...
		    <?php foreach($datas as $r) { ?>
				<tr>
					<td align="center"><input class="inputcheckbox " name="ids[]" value="<?php echo $r['uid'];?>" type="checkbox"></td>
	    ...
	    <div class="btn">
			<input type="button" id='js-button' class="button" value="取消" data-id='?m=community&c=usermanage&a=canceled_all_recommend' />
	    </div>
