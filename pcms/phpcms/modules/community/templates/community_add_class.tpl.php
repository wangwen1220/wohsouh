...
<form action="?m=community&c=communityey&a=community_add_class" method="post" id="myform" enctype="multipart/form-data">
...
<tbody>
	...
	<!--tr>
		...
		<td><input id="pic" type="file" name="image" value="" size="25"/></td>
	</tr-->
</tbody>
</table>
<div class="bk15"></div>
