...
<!--
	$(function(){
		...
		$("album_name").formValidator({onshow:"请输入专辑名称",onfocus:"请输入专辑名称",oncorrect:"<?php echo L('input_right');?>"}).inputValidator({min:1,onerror:"请输入专辑名称"});
	})
//-->
</script>
...
<div class="bk15"></div>
<input type="hidden" name="tagid" value="<?php echo $list_arr[0]['id'] ?>"/>
