...
<a class="add fb tab_content_link" href="?m=content&c=content&a=add&menuid=&catid=<?php echo $catid;?>&pc_hash=<?php echo $_SESSION['pc_hash'];?>" ><em><?php echo L('add_content');?></em></a>
...
<?php }?>
<span>|</span><a id='reload_content_list' href='javascript:;'><em>刷新列表</em></a>
</div>
...
<div class="table-list">
    <table width="100%">
        <thead>
            ...
            <th width="70">
            <?php if ($list=="desc"){?>
            <a href="?m=content&c=content&a=init&menuid=822&catid=<?php echo $catid;?>&pc_hash=<?php echo $pc_hash;?>&s_user=asc"><?php echo L('publish_user');?></a>
            <?php }else{?>
            <a href="?m=content&c=content&a=init&menuid=822&catid=<?php echo $catid;?>&pc_hash=<?php echo $pc_hash;?>&s_user=desc"><?php echo L('publish_user');?></a>
            <?php }?>
            </th>
            <th width="118">
            <?php if ($list1=="desc"){?>
            <a href="?m=content&c=content&a=init&menuid=822&catid=<?php echo $catid;?>&pc_hash=<?php echo $pc_hash;?>&s_time=asc"><?php echo L('updatetime');?></a>
            <?php }else{?>
            <a href="?m=content&c=content&a=init&menuid=822&catid=<?php echo $catid;?>&pc_hash=<?php echo $pc_hash;?>&s_time=desc"><?php echo L('updatetime');?></a>
            <?php }?>
            </th>
...
<tbody>
	...
	?>
		...
		<td align='center'>
		<a href="javascript:;" 
		onclick="window.open('?m=content&c=index&a=show&catid=<?php echo $catid;?>&id=<?php echo $r['id'];?>','manage')">查看</a> | <a class='tab_content_link tab_content_edit' href="?m=content&c=content&a=edit&catid=<?php echo $catid;?>&id=<?php echo $r['id']?>&pc_hash=<?php echo $_SESSION['pc_hash'];?>" ><?php echo L('edit');?></a> 
		| <a href="javascript:view_comment('<?php echo id_encode('content_'.$catid,$r['id'],$this->siteid);?>','<?php echo safe_replace($r['title']);?>')"><?php echo L('comment');?></a></td>
	</tr>
     <?php }
	}
	?>
...
<script language="javascript" id='content_list' type="text/javascript" src="<?php echo JS_PATH?>huoshow_editor.js"></script>
