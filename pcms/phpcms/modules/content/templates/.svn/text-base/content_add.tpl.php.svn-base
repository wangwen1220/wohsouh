...
<?php }?>
    ...
    <div class="col-auto">
    	<div class="col-1">
        	<div class="content pad-6">
<table width="100%" cellspacing="0" class="table_form" id='js_table_form'>
	<tbody>
<?php
...
<div class="fixed-bottom">
    ...
    <div class="button"><input value="<?php echo L('save_close');?>" type="submit" name="dosubmit" class="cu" style="width:145px;" onclick="refersh_window()">
      <input type="hidden" name="draft_ajax" id="draft_ajax" value="0" />
	...
	<!--<div class="button"><input value="存草稿箱" type="submit" name="dosubmit_draft" class="cu" style="width:130px;" title="Alt+X" onclick="refersh_window_draft()"></div>-->
    <div class="button"><input value="<?php echo L('c_close');?>" type="button" name="close" onclick="refersh_window();" class="cu" style="width:70px;"></div>
      </div>
</div>
</form>
...
function refersh_window_draft()
{
	//$("#draft_ajax")[0].value=1;
	setcookie('refersh_time', 1);
}
