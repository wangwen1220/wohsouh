...
<script>
			...
			function uploadComplete(pic)
			{
				...
				} else if(top.$('#js_content iframe:visible').contents().find('#<?php echo $_GET['input']?>').length){
					var input = top.$('#js_content iframe:visible').contents().find('#<?php echo $_GET['input']?>')[0];
				} else {
				...
				} else if(top.$('#js_content iframe:visible').contents().find('#<?php echo $_GET['preview']?>').length){
					var preview = top.$('#js_content iframe:visible').contents().find('#<?php echo $_GET['preview']?>')[0];
				} else {
