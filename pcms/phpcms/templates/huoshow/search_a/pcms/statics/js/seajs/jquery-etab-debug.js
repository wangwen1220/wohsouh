	...
	$.fn.etab = function(options) {
		return this.each(function() {
			...
			var tabHandle = function($nav_item) {
				...
				if (options.fadeIn) {
					$tab_cnt_item.siblings().hide().removeClass('ui-tab-cnt-item-cur');
					$tab_cnt_item.eq(tab_index).fadeIn(options.speed, function() {
						$(this).addClass('ui-tab-cnt-item-cur');
					});
				} else {
