...
return array (
  ...
  array (
    ...
    'ishtml' => '1',
    'urlrule' => 'games/{$year}/{$month}{$day}/{$id}.shtml|games/{$year}/{$month}{$day}/{$id}_{$page}.shtml',
    'example' => 'games/2013/0129/654321.shtml',
  ),
  37 => 
  array (
    'urlruleid' => '37',
    ...
    'file' => 'show',
    'ishtml' => '1',
    'urlrule' => 'tv/{$year}/{$month}{$day}/{$id}.shtml|tv/{$year}/{$month}{$day}/{$id}_{$page}.shtml',
    'example' => 'tv/2013/0129/654321.shtml',
  ),
  38 => 
  array (
    'urlruleid' => '38',
    ...
    'file' => 'show',
    'ishtml' => '1',
    'urlrule' => 'movie/{$year}/{$month}{$day}/{$id}.shtml|movie/{$year}/{$month}{$day}/{$id}_{$page}.shtml',
    'example' => 'movie/2013/0129/654321.shtml',
  ),
);
?>