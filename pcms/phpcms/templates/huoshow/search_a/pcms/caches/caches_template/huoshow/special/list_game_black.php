		...
		<div id="main">
			<div class="ui-box ui-box-download fn-clear">
				<div class="header fn-clear">
					<!--<h2 class="site-nav"><?php echo $info['name'];?></h2>-->
			...
			<div class="ui-box ui-box-news-list">
				...
				<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
					...
					<li class="ui-news-list-item"><a href='<?php echo url_change($r[url]);?>'><?php echo $r['title'];?></a> <span>[<?php echo date('m-d',$r[inputtime]);?>]</span></li>
