...
<form action="?m=special&c=special&a=special_edit_pos" method="post" id="myform">
<table class="table_form" width="100%" cellspacing="0">
<tbody>
	<tr>
		<th width="100"><strong>推荐位：</strong></th>
		<td><input name="name" id="name" class="input-text" type="text" size="25" value="<?php echo $datas[0][name] ?>"></td>
	</tr>
</tbody>
</table>
<div class="bk15"></div>
<input type="hidden" name="id" value="<?php echo $datas[0][posid]?>"/>
