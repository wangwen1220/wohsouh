...
cmsAD_3.ADContent = "{'Images':[{'imgADLinkUrl':'http%3A%2F%2Fwww.phpcms.cn','imgADAlt':'phpcms官方','ImgPath':'http://pnews.ck.huoshow.com/uploadfile/poster/3.png'}],'imgADLinkTarget':'New','Count':'1','showAlt':'Y'}"; 
cmsAD_3.URL = "http://pnews.ck.huoshow.com/index.php?m=poster&c=index"; 
cmsAD_3.SiteID = 1; 
cmsAD_3.Width = 249; 
cmsAD_3.Height = 87; 
