...
<form name="form" id="form" action="?m=content&c=content&a=public_checkall&s=see" method="POST">
<?php echo form::select_category('category_content_'.$this->siteid,$parentid,'name="info[parentid]" id="parentid"',"请选择栏目",0,-1);?>
