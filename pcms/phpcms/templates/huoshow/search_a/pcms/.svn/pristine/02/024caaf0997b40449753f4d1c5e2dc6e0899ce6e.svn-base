...
{
	$('#tobox')[0].innerHTML="加载类别信息,请稍后...";
	$("#tobox").load("/api.php?op=contentajax&a=getcategory&catid="+ele.value); 
}
</script>
<div class="pad-10">
...
<tbody  height="200" class="nHover td-line">
	<tr> 
      <td align="center" rowspan="6">
		...
		<select name="fromid[]" id="fromid"  multiple  style="height:300px;width:350px;" onchange="change_cat(this);">
...
<script>
	...
	if(ie6){
		$("#tocatid option:disabled").css('color', '#ccc');
		$('#tocatid').change(function(){
