		...
		<tr>
			<td>
				<div class="explain-col">
					分类:
					<select name='catids' id='catids'  multiple="multiple" >
					<?php echo $string;?>
					</select>
					按字母排序：
					<select name="letters">
...
<p class="gray4"><?php echo L('create_man')?>：<a href="#" class="blue"><?php echo $info['username']?></a>， <?php echo L('create_time')?>：<?php echo format::date($info['createtime'], 1)?></p>
	...
	<td align="center"><?php echo $info['letters']?></td>
	<td align="center"><?php echo $info['votes']?></td>
	<td align="center"><?php echo $info['rated_number']?></td>
...
?>
 ...
 <div id="pages"><?php echo $page_str//echo $this->db->pages;?></div><script>window.top.$("#display_center_id").css("display","none");</script>
</form>
</div>
</body>
</html>
