...
<div class="col-2 col-auto" >
	...
	<div class="content">
		...
		<iframe scrolling="No" width="100%" height="750" frameborder="0" src="/index.php?m=content&c=content&a=init&menuid=822&pc_hash=<?php echo $_SESSION['pc_hash'];?>&fusername=<?php echo $admin_username?>&pagesize=20&iframep=yes">
		</iframe>
	    </div>
	</div>
</div>
