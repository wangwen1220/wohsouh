...
class Db
{
    ...
    {
        $this->Db(DB_HOST, DB_USER, DB_PASSWORD, DB_DATABASE, DB_CHARSET, 0);
    }

    function Db($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8', $pconnect = 0)
    {
    ...
    function affected_rows()//判断影响的行数
    {
