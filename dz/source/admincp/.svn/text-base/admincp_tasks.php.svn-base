...
if(!($operation)) {
	...
	if(!submitcheck('tasksubmit')) {
		...
		while($task = DB::fetch($query)) {
			...
			} elseif($task['reward'] == 'money') {    //add by Chris
				$moneyname = DB::result_first("SELECT name FROM ".DB::table('common_money')." WHERE moneyid='$task[prize]'");
				$reward = '货币 '.$moneyname.' '.$task['bonus'].' 个';
	...
	if(!submitcheck('addsubmit')) {
		...
		showsetting('tasks_add_reward', array('reward', array(
			array('', cplang('none'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => 'none')),
			array('money', "货币", array('reward_money' => '', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => 'none')),  //add by Chris
			array('credit', cplang('credits'), array('reward_money' => 'none', 'reward_credit' => '', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => 'none')),
			$_G['setting']['magicstatus'] ? array('magic', cplang('tasks_reward_magic'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => '', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => 'none')) : '',
			$_G['setting']['medalstatus'] ? array('medal', cplang('medals'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => '', 'reward_group' => 'none', 'reward_invite' => 'none')) : '',
			$_G['setting']['regstatus'] > 1 ? array('invite', cplang('tasks_reward_invite'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => '')) : '',
			array('group', cplang('tasks_add_group'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => '', 'reward_invite' => 'none'))
		)), '', 'mradio');
		...
		showtagheader('tbody', 'reward_money');  //add by Chris
		showsetting('货币各类', array('prize_money', array(array(0 => 1, 1 => '秀币'),array(0 => 2, 1 => '火币'))), 0, 'select');
		showsetting('货币金额', 'bonus_money', '0', 'text');
		showtagfooter('tbody');
	...
	if(!submitcheck('editsubmit')) {
		...
		showsetting('tasks_add_reward', array('reward', array(
			array('', cplang('none'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none')),
			array('money', "货币", array('reward_money' => '', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => 'none')),  //add by Chris
			array('credit', cplang('credits'), array('reward_money' => 'none', 'reward_credit' => '', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none')),
			$_G['setting']['magicstatus'] ? array('magic', cplang('tasks_reward_magic'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => '', 'reward_medal' => 'none', 'reward_group' => 'none')) : '',
			$_G['setting']['medalstatus'] ? array('medal', cplang('medals'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => '', 'reward_group' => 'none')) : '',
			$_G['setting']['regstatus'] > 1 ? array('invite', cplang('tasks_reward_invite'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => 'none', 'reward_invite' => '')) : '',
			array('group', cplang('tasks_add_group'), array('reward_money' => 'none', 'reward_credit' => 'none', 'reward_magic' => 'none', 'reward_medal' => 'none', 'reward_group' => ''))
		)), $task['reward'], 'mradio');
		...
		showtagheader('tbody', 'reward_money', $task['reward'] == 'money');  //add by Chris
		showsetting('货币各类', array('prize_money', array(array(0 => 1, 1 => '秀币'),array(0 => 2, 1 => '火币'))), $task['prize'], 'select');
		showsetting('货币金额', 'bonus_money', $task['bonus'], 'text');
		showtagfooter('tbody');
		...
		if(!$_G['gp_name'] || !$_G['gp_description']) {
			...
			cpmsg('tasks_time_invalid', '', 'error');
		} elseif($reward && (!$prize || ($reward == 'credit' && !$bonus) || ($reward == 'money' && !$bonus))) {
			cpmsg('tasks_reward_invalid', '', 'error');
		}
