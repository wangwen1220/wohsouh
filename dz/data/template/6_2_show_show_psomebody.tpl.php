<? if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('show_psomebody');
0
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/live_header.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/player.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/shareto.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/gift.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/vote.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/personalinfo.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/chat.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/fans_rank.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/live_footer.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/home/space_live_header.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/show/notice.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/common/footer_1_5.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/common/header_space_common.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
|| checktplrefresh('./template/huoshow/show/show_psomebody.htm', './template/huoshow/home/space_diy.htm', 1334280498, '2', './data/template/6_2_show_show_psomebody.tpl.php', './template/huoshow', 'show/show_psomebody')
;?>
<!DOCTYPE html>
<html>
        <head>
...
<div id="leftbf">
  <div id="dakuang">
    <div id="video_area"><div class="live-object-box">
...
<div class="room-list">
  ...
  <div class="vote_right">
    ...
    <div id="vote_button_box">
      <? if($usertype == 1) { ?>
      <a href="javascript:;" id="canVoteStatus"><img src="/static2/images/vote_stop.gif" onclick="stopVote()"/></a>
      <? } else { ?>
      <div class="vote-button vote-button-wait">
        <p><span class="red">[<span id="vote_timer_wait">60</span>]</span> 秒后可以给<br />TA赠送魅力之星</p>
      </div>
      <div class="vote-button vote-button-success">
        <p><span class="vote_success">赠送成功</span><br /><span class="red">[<span id="vote_timer_success">60</span>]</span> 秒后继续赠送</p>
      </div>
      <a href='javascript:vote();' class="vote-button vote-button-vote"><img id="vote_button" src="/static2/images/star.gif"/></a>
    <? } ?>
    </div>
  </div>

  <div class="vote_left">
    <h1 class="vote_left_zi">我正在参加
      <a href="<?=WWW_URL?>zhuanti/" target="_blank" class="vote_left_crude">火秀魅力之星大赛</a> 支持我吧！
    </h1>
    <div style="text-align:right;padding-right:10px;">
      <span>
        <img style="position:absolute;" width="16" height="16" src="/static2/images/vote_help.jpg"
        title="魅力指数为魅力值占60%，魅力之星个数占40%，通过换算得到的一个指数，最高为10000。" />
      </span>
    </div>
    <div class="vote_zi">
      <table>
        <tr>
          ...
          <td>
            <span class="blue" id="charm_value">－</span>
          </td>
          <td>
            魅力之星：
          </td>
          <td>
            <span class="green" id="vote_value">－</span>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span class="red" id="score_value">－</span>
          </td>
          <td>
            当前排名：
          </td>
          <td>
            <span class="red" id="paiming_value">－</span>
          </td>
        </tr>
      </table>
    </div>
...
<? if($space['uid'] != $_G['uid']) { if($is_att !=1) { ?>
<span id='live_follow' style="padding-left:35px;"><a href="/huoshow/module/weibo/ajax/weibo_user_dynamic_ajax.php?tab=ajax_user_follow&amp;dst_uid=<?=$space['uid']?>&amp;type=live"
onclick="<? if($_G['uid']) { ?>showWindow('register', this.href)
<? } else { ?>showWindow('login', 'member.php?mod=logging&action=login');<? } ?>">
<img src="/static2/images/att.gif"></span>
<? } } ?>
        </li>
        <li>
