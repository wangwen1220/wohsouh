...
0
|| checktplrefresh('./template/huoshow/member/login.htm', './template/huoshow/common/seccheck.htm', 1358322030, '2', './data/template/6_2_member_login.tpl.php', './template/huoshow', 'member/login')
