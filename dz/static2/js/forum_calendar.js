...
function closecalendar(event) {
	...
	$("calendar_if").style.display = 'none';
}
...
function showcalendar(event, controlid1, addtime1, startdate1, enddate1) {
	...
	if(!cif){
		...
		cif.frameBorder = '0';
		cif.scrolling = "no";
		cif.style.cssText = "position:absolute;width:0; height:0;display:none;";
		document.body.appendChild(cif);
	}
	cif.style.left = p['left']+'px';
	cif.style.top = (p['top'] + 20)+'px';
	cif.style.width = $('calendar').offsetWidth + "px";
	cif.style.height = $('calendar').offsetHeight + "px";
